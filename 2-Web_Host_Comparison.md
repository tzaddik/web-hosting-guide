# <a name="top"></a>Web Hosting Websites Comparison – Panthur, SiteGround & Netregistry
...
## <a name="domain"></a>Domain name service [^](#top)
...
## <a name="privacy"></a>Privacy (DNS) [^](#top)
...
## <a name="email"></a>Email and mailing list services [^](#top)
...
## <a name="data"></a>Data capacity [^](#top)
...
## <a name="security"></a>Security [^](#top)
...
## <a name="database"></a>Scripting and Database options [^](#top)
...
## <a name="apps"></a>Server applications [^](#top)
...
### Panthur
They offer  support for **CloudFlare** to help speed up site performance and security.
...
## <a name="performance"></a>Performance monitoring [^](#top)
...
## <a name="backup"></a>Backup and restore services [^](#top)
...
## <a name="commerce"></a>Payment technology options [^](#top)
...
The only area they were very poor in was the lack of a backup/restore service.
